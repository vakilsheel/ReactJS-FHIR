...
import { Navigation, Footer, Home, LabReports, PatientSearch, PCPMessages, RequestAppt, Resources } from "./components";
    ...
    <div className="App">
      ...
      <Router>
        ...
        <Switch>
          ...
          <Route path="/reqest_appt" exact component={() => <RequestAppt />} />
